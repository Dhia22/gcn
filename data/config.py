...
DWG_GENERATED_CLASSES = ("object","cotation")
...
generated_dwg_dataset = dataset_base.copy({
    'name': 'DWG GENERATED',
    ...
    'valid_info': './data/val/annotations.json',

    'class_names': ('object','cotation'),
    'label_map': { 1:  1, 2: 2 }
})
...
yolact_resnet50_generated_dwg_config = yolact_resnet50_config.copy({
    'name': 'yolact_plus_resnet50_generated_dwg',
    # Dataset stuff
    'dataset': generated_dwg_dataset,
    'num_classes': len(generated_dwg_dataset.class_names) + 1,
